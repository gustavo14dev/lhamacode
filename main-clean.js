...
class UI {
    constructor() {
        ...
        this.currentCreateType = null; // 'slides', 'document', 'table'
    ...
    init() {
        ...
        this.renderChatList();
        this.transitionToDarkMode();
        
        // Carregar sistema de debug se necessário
        if (DEBUG) {
            import('./debug-system.js').then(module => {
                DebugSystem = module.default;
        ...
        this.proactiveSuggestions = new ProactiveSuggestions(this);
        this.preferenceLearning = new PreferenceLearning(this);
    }

    // ... (outros métodos da classe UI permanecem iguais)
...
\\end{document}`;
    ...
    // ... (restante dos métodos da classe UI permanecem iguais)
}

// Exportar a classe UI
export { UI };
